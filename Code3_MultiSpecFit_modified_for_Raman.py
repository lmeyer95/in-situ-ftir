...
"""
#This code uses as a base Jack's MultiSpecFit.py code for FTIR data. Not much
#has been changed in this code aside from a few things that make the code work 
#best for the Raman mapping application. User inputs have been defined as 
# *USER INPUT*
...
# # *USER INPUT* Define your intial parameters here. I would recommend using these 
# peaks as a starting point since they reflect peaks that I have identified with 
#my literature survey of Raman peaks. Everything else works exactly as Jack's code
#does
initial_vals = {'folder':r'C:\Users\LMEYER\Documents\in situ Raman\PECVD_NMP_082422\Voltage hold\6hr\CSVs_pybaseline',
                'export_folder' : r'C:\Users\LMEYER\Documents\in situ Raman\PECVD_NMP_082422\Voltage hold\6hr\Multipeak_fits',
                ...
                'amount' : 36, # How many total spectra do you want to fit? 
                ...
                'lower_bound' : 200, # Lowest wavenumber of fitting domain
                'upper_bound' : 1799, # Highest wavenumber of fitting domain
                'Fixed_Peaks' : [384], # Peaks not allowed to move during the fit
                'Mobile_Peaks' : [556,570,729,733,740,741,742,904,905,472, 520, 780,800, 900,1100, 1160,1250,1275,1300,1420],# Peaks allowed to move during the fit
                'tolerance' : 15, # Amount allowed to deviate from peaks defined above 
                'min_amplitude' : 1, # Define minimum amplitude. Get this value from SingleSpecFit
                'max_amplitude' : 200, # Define maximum amplitude. Get this value from SingleSpecFit
                ...
                'first_vals' : pd.DataFrame(np.array([[1.5,905,1.5],[1.5,904,1.5],[1.5,742,1.5],[1.5,741,1.5],[1.5,740,1.5],[1.5,733,1.5],[1.5,729,1.5],[1.5,570,1.5],[1.5,556,1.5],[1.5,384,1.5],[1.5,472,1.5],[1.5,1100,1.5],[1.5,520,1.5],[1.5,1275,1.5],[1.5,800,1.5] ,[1.5,780,1.5],[1.5,900,1.5],[1.5,1160,1.5],[1.5,1250,1.5],[1.5,1300,1.5],[1.5,1420,5]]),
